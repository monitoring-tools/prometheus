...
import "github.com/monitoring-tools/prometheus/pkg/textparse"
...
//
//     go-fuzz-build -func FuzzParseMetric -o FuzzParseMetric.zip github.com/monitoring-tools/prometheus/promql
//
