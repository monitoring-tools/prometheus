...
For details on the request and response messages, see the [remote storage protocol buffer definitions](https://github.com/monitoring-tools/prometheus/blob/master/prompb/remote.proto).
